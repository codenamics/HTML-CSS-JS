...
var _fetch = __webpack_require__(329);
...
btn.addEventListener('click', function () {
    ...
    if (country !== '' && city !== '') {
        _fetch.fetchForcast.fetchCall(country, city).then(function (res) {
            return _ui.ui.showWeather(res.resData);
        }).catch(function (err) {
            return console.log(err);
        });
        _fetch.fetchForcast.fetchCurrent(country, city).then(function (res) {
            return _ui.ui.showCurrent(res.resData);
        }).catch(function (err) {
            return console.log(err);
        });
...
var FetchData = function () {
    ...
    _createClass(FetchData, [{
        key: 'fetchCurrent',
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(country, city) {
                var getData, resData;
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return fetch('http://api.openweathermap.org/data/2.5/weather?q=' + city + ',' + country + '&units=metric&appid=' + this.apiKey);
        ...
        key: 'fetchCall',
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(country, city) {
                var getData, resData;
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return fetch('http://api.openweathermap.org/data/2.5/forecast?q=' + city + ',' + country + '&units=metric&appid=' + this.apiKey);
...
var fetchForcast = exports.fetchForcast = new FetchData();
...
var UI = function () {
    ...
    _createClass(UI, [{
        key: 'showCurrent',
        value: function showCurrent(weather) {
        ...
        key: 'showWeather',
        value: function showWeather(weather) {

            var output = '';

            var forcasts = weather.list.slice(1, 5);
            forcasts.forEach(function (forcast) {
